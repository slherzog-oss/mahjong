...
| 2 | Schwierigkeitsstufen Anfänger/Mittel/Schwer mit Kalibrierungsskript (`scripts/simulate.js`), Gefahrenbewertung, Fehlerinjektion; mobiler Feinschliff (Safe Areas, Wake Lock, Install-Knopf, Querformat, Export/Import) | fertig; Feinkalibrierung nach Recherche offen |
...
- Tests: `npm test` (Node ≥ 20, keine Abhängigkeiten), inkl. Eigenschaftstests und
  Zufallspartien; CI auf GitHub Actions.
